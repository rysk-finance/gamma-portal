    ...
    <StyledContainer>
      ...
      {networkId !== SupportedNetworks.Mainnet ? (
        ...
        <>
          ...
          {selectedTab === 0 && <MakeOrder paymentTokenBalance={wethBalance} squeethBalance={squeethBalance} />}
          {selectedTab === 1 && <TakerOrder paymentTokenBalance={wethBalance} squeethBalance={squeethBalance} />}
        </>
      )}
    </StyledContainer>
  )
